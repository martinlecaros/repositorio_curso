...
CREATE TABLE IF NOT EXISTS `optica`.`Montura` (
  ...
  UNIQUE INDEX `id_montura_UNIQUE` (`id_montura` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `optica`.`Gafas` (
  ...
  INDEX `fk_Gafas_Montura1_idx` (`Montura_id_montura` ASC),
...
CREATE TABLE IF NOT EXISTS `optica`.`Clientes` (
  ...
  INDEX `fk_Clientes_Clientes1_idx` (`id_referido` ASC),
...
CREATE TABLE IF NOT EXISTS `optica`.`Ventas` (
  ...
  INDEX `fk_Ventas_Gafas1_idx` (`Gafas_idProductos` ASC),
